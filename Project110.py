...
fig = ff.create_distplot([data],["stuff"],show_hist = False)
fig.show()

mean = statistics.mean(data)
std_deviation = statistics.stdev(data)
print("mean of reading time",mean)
print("Standered Deviation of reading time",std_deviation)
...
print("Standerd Deviation of Sampling Distrubtion:-",std_deviation)
print("Mean of the Samping Disturbution:-",mean)
fig = ff.create_distplot([mean_list],["idkman"],show_hist = False)
fig.add_trace(go.Scatter(x=[mean,mean],y=[0,0.2],mode="lines",name="MEAN"))
fig.show()

#Finding The Standered Deviation of the Stating and Ending Values 
...
#Plotting the graph with the traces 
...
#Finding the mean for the first data and plotting on the graph/plot
df = pd.read_csv("sample_2.csv")
data = df["reading_time"].tolist()
mean_of_sample1 = statistics.mean(data)
print("Mean of the Sample 1:-",mean_of_sample1)
fig = ff.create_distplot([mean_list],["Student Marks"],show_hist = False)
fig.add_trace(go.Scatter(x=[mean,mean],y=[0,0.17],mode="lines",name="MEAN"))
fig.add_trace(go.Scatter(x=[mean_of_sample1,mean_of_sample1],y=[0,0.17],mode="lines",name="MEAN OF SAMPLE1"))
fig.add_trace(go.Scatter(x=[first_std_deviation_end,first_std_deviation_end],y=[0,0.17],mode="lines",name="Standered Deviation1 End"))
